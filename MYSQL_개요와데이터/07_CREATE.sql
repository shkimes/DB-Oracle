...
수정하고(ALTER)
삭제(DROP)
등 데이터 전체구조를 정의하는 언어로 주로 DB관리자, DB설계자가 사용함

ORACLE 은
TABLE, VIEW, SEQUENCE, INDEX, PACKAGE, TRIGGER, PROCEDURE, FUNCTION, SYNONYM, USER 등 생성

MYSQL 은
DATABASE, TABLE, VIEW, SEQUENCE, INDEX, PACKAGE, TRIGGER, PROCEDURE, FUNCTION, SYNONYM, USER 등 생성
...
-> INSERT UPDATE 할 때 해당 컬럼에 값을 넣지 않으면 지정한 기본값이 들어간다. 

*/

/*

-- CREATE 를 생성할 때 제약조건은 15_제약조건.SQL 참조
